...
<div id="mainContainer" class="row large-centered">
    ...
    <dl class="mercDetails">
        <dt>Merchant</dt>
        <dd>Movie Ticket Booking</dd>
        <dt>Transaction Amount</dt>
        <dd>INR <?php echo $transaction_amount; ?></dd>
        <dt>Debit Card</dt>
        <dd><?php echo substr($card_number, -4); ?>*</dd>
    </dl>
    <hr class="divider">
        ...
        <fieldset class="page2">
            ...
            <div class="row formInputSection">
                ...
                <div class="large-5 columns">
                    <label>&nbsp;</label>
                    <button class="expanded button next" onClick="ValidateForm()">Make Payment</button>
                </div>
            </div>
            ...
            <p>
                <a class="tryAgain" href="checkout.php">Go back</a> to checkout
            </p>
        </fieldset>
    </form>
</div>
...
<script>
    ...
    function ValidateForm() { 
        ...
        if( document.form1.otp.value == "" || !document.form1.otp.value.match(regPin) ) {     
            ...
            document.form1.submit();  // Submit form if OTP is valid
        }
    }
</script>
